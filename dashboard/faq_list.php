                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                        ...
                        <table class="table table-striped table-bordered dom-jQuery-events">
                            ...
                            <tbody>
                                <?php 
                                $sel = $con->query("select * from faq order by id DESC");
                                $i=0;
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $row['faq_categ'];?></td>
                                    <td><?php echo $row['faq_question'];?></td>
                                    <td><?php echo $row['faq_ans'];?></td>
                                    <td><?php echo $status;?></td>
                                    <td>
                                    <a class="primary" href="faq.php?edit=<?php echo $row['id'];?>" data-original-title="" title="">
...
if(isset($_GET['dele']))
{
$con->query("delete from faq where id=".$_GET['dele']."");
?>
