                        ...
                        <table class="table table-striped table-bordered dom-jQuery-events">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rkl['banner_text1'];?></td>
                                    <td><?php echo $rkl['banner_text2'];?></td>
                                    <td><?php echo $rkl['banner_subtxt'];?></td>
                                    <td><?php echo $rkl['banner_btn'];?></td>
                                    <td><?php echo $rkl['banner_btn_text'];?></td>
                                    <td><?php echo $rkl['btn_url'];?></td>
                                    <td>
