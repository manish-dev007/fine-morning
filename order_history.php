...
<html lang="en">
<head>
    <?php $page_name = 'order_history';require 'include/header.php'; ?>
<meta name="description" content="<?php echo $meta_descr; ?>">
<meta property="og:title" content="<?php echo $meta_title; ?>">
<meta name="author" content="Fine Morning Pharma">
<title><?php echo $meta_title; ?></title>

<link rel="canonical" href="https://www.finemorningpharma.com/order_history" />
          ...
          <div class="row">
              <div class="col-md-6 col-data">
                <ul>
                  ...
                  <li class="total_tax">Total Tax : <b></b></li>
