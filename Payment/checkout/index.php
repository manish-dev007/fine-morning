...
if (!isset($_SESSION['order_id'])) { ?>
  <script type="text/javascript">alert('Order ID not provided...Please Contact Fine Morning Support.');window.location.href = '../../checkout.php';</script>
<?php }
...
$store_name = 'Fine Morning Pharmacy';
$store_logo = '../../dashboard/'.$fset["logo"];
$merchant_order_id = $_SESSION["order_id"];
