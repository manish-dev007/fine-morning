...
<html>
    <head>
        <title>Fine Morning | Payment Page</title>
        <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-2 text-center text-lg-left">
                        ...
                        <a href="#" class="site-logo">
                            <img src="../../dashboard/<?php echo $fset['logo']; ?>" alt="Fine Morning">
                        </a>
                    </div>
                </div>
            </div>
...
options.modal = {
    ondismiss: function() {
        ...
        window.location = "https://www.finemorningpharma.com/checkout.php";
    },
    escape: true,
    backdropclose: false
};
